...
<head>
  ...
  function myFuntion(userName){
      ...
      // IF THIS IS OK, THEN POPUP WILL BECOME
      // read from the GET request of the browser URL
      ...
      //inner function to display details
    //     function showDetails(){
    //       var name=document.getElementByName('hiddenUserName'+c).value;
    //       document.getElementById("mailPopup").innerHTML = ("<h3 style=font-size:150% class=fontBlue>Review Summary</h3>"+"  <b>Name :</b><br/>"+name);
    //     }
    // return showDetails();
...
<?php
    ...
    <div class="container" style="width:30%; float :right">
      ...
      <br/><br/>
      <a class="formText" name="patientName" id="patientName" >CareTaker</a>
      <?php
      include("dbConnect.php");
