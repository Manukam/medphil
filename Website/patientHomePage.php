...
<div class="container" style="width:70%; margin-top:125px; margin-left:120px">
  <center>
  <h1> My Stats</h1>
</center>
<table style="margin-left:-120px" >
  ...
  <?php
    ...
    $getMedicineNameQuery="SELECT medicineName,dosageTime,dosageStatus,	id FROM  patientdosage WHERE 	patientUserName='$_SESSION[session1]'";
    $resultFirstName=mysqli_query($con,  $getMedicineNameQuery);
...
echo"<td class=formText".$recentFirstNameRow['dosageTime'].">".$recentFirstNameRow['dosageTime']."</td>";

echo"<td class=formText".$recentFirstNameRow['dosageStatus'].">".$recentFirstNameRow['dosageStatus']."</td>";

echo"<td class=formText".$recentFirstNameRow['id'].">".$recentFirstNameRow['id']."</td>";
